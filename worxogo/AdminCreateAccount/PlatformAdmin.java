...
public class PlatformAdmin {
	...
	public void AccountAdminlogin(){
		System.setProperty("webdriver.chrome.driver",
		 ...
		 driver.findElement(By.id("edit-mail")).sendKeys("ashish6@mailinator.com");
		 ...
		 driver.findElement(By.id("edit-profile-main-field-last-name-und-0-value")).sendKeys("PlatformAdmin");
