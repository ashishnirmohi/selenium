...
public class ProjectCreator {
	...
	public void AccountAdminlogin(){
		System.setProperty("webdriver.chrome.driver",
		 ...
		 driver.findElement(By.id("edit-name")).sendKeys("AshishProjectCreator");
		 driver.findElement(By.id("edit-mail")).sendKeys("ashish3@mailinator.com");
		 ...
		 driver.findElement(By.id("edit-profile-main-field-last-name-und-0-value")).sendKeys("ProjectCreator");
