...
public class Management {
	...
	public void AccountAdminlogin(){
		System.setProperty("webdriver.chrome.driver",
		 ...
		 driver.findElement(By.id("edit-name")).sendKeys("AshishManagement");
		 driver.findElement(By.id("edit-mail")).sendKeys("ashish2@mailinator.com");
		 ...
		 driver.findElement(By.id("edit-profile-main-field-last-name-und-0-value")).sendKeys("Management");
