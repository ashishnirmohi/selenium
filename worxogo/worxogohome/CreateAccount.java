...
public class CreateAccount {
	...
	public void createAccount(){
		System.setProperty("webdriver.chrome.driver",
		 ...
		 driver.findElement(By.id("edit-name")).sendKeys("AshishKumar");
		 driver.findElement(By.id("edit-mail")).sendKeys("nirmohi.qa@gmail.com");
		 driver.findElement(By.id("edit-profile-main-field-first-name-und-0-value")).sendKeys("Ashish Kumar");
		 driver.findElement(By.id("edit-profile-main-field-last-name-und-0-value")).sendKeys("Nirmohi");
		/*
		...
		// 	driver.findElement(By.linkText("Log in")).click();
			...
			driver.findElement(By.id("edit-roles-7")).click();
			driver.findElement(By.id("edit-submit")).click();
